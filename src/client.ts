        ...
        try {
          ...
          if (!(err instanceof ModbusExceptionError)) {
            if (transport.notifyDeviceDisconnected) {
              ...
              if (err instanceof ModbusTimeoutError) errorType = ConnectionErrorType.Timeout;
              else if (err instanceof ModbusCRCError) errorType = ConnectionErrorType.CRCError;
