 ...
 * @param {number} categoryId - категория идентификации (по умолчанию 0x01)
 * @param {number} objectId - идентификатор объекта (по умолчанию 0x00)
 * @returns {Uint8Array}
 */
 ...
 * @returns {Object} - объект с информацией об идентификации
...
function parseReadDeviceIdentificationResponse(pdu) {
    ...
    if (pdu[1] !== MEI_TYPE) {
        throw new Error(`Invalid MEI type: expected 0x${MEI_TYPE.toString(16)}, got 0x${pdu[1].toString(16)}`);
    }
