// function-codes/write-multiple-registers.js

const FUNCTION_CODE = 0x10;
const MIN_REGISTERS = 1;
const MAX_REGISTERS = 0x7B; // 123
const MIN_ADDRESS = 0;
 ...
 * @param {number[]} values - массив значений регистров
 * @returns {Uint8Array}
...
function buildWriteMultipleRegistersRequest(startAddress, values) {
    ...
    if (!Array.isArray(values) || !Number.isInteger(quantity) || 
        quantity < MIN_REGISTERS || quantity > MAX_REGISTERS) {
